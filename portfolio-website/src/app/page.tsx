...
import Resume from '../../public/JLarsenResumeFall2024.pdf';
import J22 from '../../public/j22.png';
    ...
    <Stack direction="row" alignItems="center" justifyContent="space-around" style={{width: '100%', height: '100%'}}>
      <Stack direction='column' alignItems="center" style={{padding: '15px', width: '350px'}}>
        <Stack direction='row' alignItems="center">
          ...
          <Box style={{height: '175px', width: '175px'}} onClick={()=>window.open('/')}>
            <Image alt="j22 picture" src={J22}/>
          </Box>
        </Stack>
        <Stack textAlign="left" style={{width: '100%', marginTop: '75px'}}>
          <h2 style={{fontSize: 'larger'}}>Hei hei!</h2><br/>
          <h2>My name is Julian. I currently study at the University of Central Florida. I&apos;m interested in <span className='link'>computer vision</span> and sailing. If you are interested in getting to know me more, you can check out my <span className='link' onClick={()=>{window.open(Resume)}}>Resume</span>. </h2>
        </Stack>
